    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto text-center">
          <Badge className="mb-4 bg-emerald-100 text-emerald-800 hover:bg-emerald-100">Blog</Badge>
          <h1 className="text-5xl md:text-6xl font-bold text-slate-900 mb-6">
            Financial <span className="text-emerald-600">Insights</span>
          </h1>
          <p className="text-xl text-slate-600 mb-8 max-w-3xl mx-auto">
            Expert tips, industry trends, and financial guidance to help your business thrive.
          </p>
        </div>
      </section>
